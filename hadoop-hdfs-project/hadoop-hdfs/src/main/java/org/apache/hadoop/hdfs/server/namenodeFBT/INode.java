...
import org.apache.hadoop.hdfs.server.namenodeFBT.INodeDirectory;
import org.apache.hadoop.hdfs.server.namenodeFBT.INode.DirCounts;
...
public abstract class INode implements Comparable<byte[]>, Serializable {
	...
	//protected PermissionStatus permisionStatus;
	...
	//add
	  ...
	  protected void setPermissionStatus(PermissionStatus ps) {
		StringUtility.debugSpace("setPermissionStatus");
	  ...
	  protected PermissionStatus getPermissionStatus() {
		  StringUtility.debugSpace("INode.getPermissionStatus");
	  ...
	  public String getUserName() {
		StringUtility.debugSpace("INode.getUser");
	  ...
	  protected void setUser(String user) {
		  StringUtility.debugSpace("INode.setUser");
	  ...
	  public String getGroupName() {
		  StringUtility.debugSpace("INode.getGroupName");
	  ...
	  protected void setGroup(String group) {
	    //TODO
		  StringUtility.debugSpace("INode.setGroupName");
		int n = SerialNumberManager.INSTANCE.getGroupSerialNumber(group);
	    updatePermissionStatus(PermissionStatusFormat.GROUP, n);
	  }
	  /** Get the {@link FsPermission} */
	  public FsPermission getFsPermission() {
		  StringUtility.debugSpace("INode.getFsPermission");
	    return new FsPermission(
	        (short)PermissionStatusFormat.MODE.retrieve(permission));
	  }
	  protected short getFsPermissionShort() {
		  StringUtility.debugSpace("INode.getFsPermissionShort");
	    return (short)PermissionStatusFormat.MODE.retrieve(permission);
	  }
	  /** Set the {@link FsPermission} of this {@link INode} */
	  protected void setPermission(FsPermission permission) {
		  StringUtility.debugSpace("INode.setFsPermission");
	  ...
	  LocatedBlocks createLocatedBlocks(ArrayList<LocatedBlock> blocks) {
